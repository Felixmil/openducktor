        ...
        >
          <DialogHeader>
            ...
            <DialogDescription>
              ...
              {running && " Archiving also stops the running session."}
            </DialogDescription>
          </DialogHeader>
            ...
            <DialogBody className="mt-4 flex flex-col gap-4">
              ...
              {removeWorktree && preview.data?.hasUncommittedChanges && (
                <p role="alert" className="flex items-start gap-2 text-sm text-destructive">
                  ...
                  This worktree has local changes. Removing it will permanently discard them,
                  including untracked files.
                </p>
              )}
              {removeWorktree && preview.data && !preview.data.worktreeExists && (
                <p role="alert" className="text-sm text-destructive">
                  The worktree is already missing. Archiving will finish removing its branch if it
                  still exists.
                </p>
              )}
              {error && (
